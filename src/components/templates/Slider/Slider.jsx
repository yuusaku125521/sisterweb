...
const SimpleSlider = () => {
  ...
  return (
    ...
    <Slider {...settings} style={bodystyle}>
      ...
      <div>
        <img src={img1} style={Sliderstyle} />
      </div>
      <div>
        <img src={img2} style={Sliderstyle} />
      </div>
      {/* <div>
        3<img src={img3} style={Sliderstyle} />
      </div> */}
      <div>
        <img src={img4} style={Sliderstyle} />
      </div>
      <div>
        <img src={img5} style={Sliderstyle} />
      </div>
      <div>
        <img src={img6} style={Sliderstyle} />
      </div>
    </Slider>
  );
}
